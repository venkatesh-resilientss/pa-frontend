...
export const FORGOT_PASSWORD = `${baseUrl}/api/forgot-password` //Forgot Password
...
export const GET_ONBOARDED_CLIENTS = `${baseUrl}/api/onboardedclients` //OnBoarded Clients
...
export const BANKS_DETAIL_ENDPOINT = (id: string) =>
  `${baseUrl}/api/banks/${id}` // Bank Details
...
export const SERIES_DETAIL_ENDPOINT = (id: string) =>
  `${baseUrl}/api/series/${id}` //Series Details
...
export const CURRENCY_DETAIL_ENDPOINT = (id: string) =>
  `${baseUrl}/api/currencies/${id}` //currencies Details
...
export const BUDGETS_DETAIL_ENDPOINT = (id: string) =>
  `${baseUrl}/api/budgets/${id}` // budgets Details
...
export const COUNTRIES_DETAIL_ENDPOINT = (id: string) =>
  `${baseUrl}/api/countries/${id}` //countries Details
