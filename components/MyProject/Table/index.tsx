...
import { ChevronDown, Share, Printer, FileText, File, Grid, Copy, Plus, Search, ArrowDown } from 'react-feather'
...
const DataTableWithButtons = ({ data, columns, tableTitle, showButton, buttonClick, buttonName }) => {
  // ** States
