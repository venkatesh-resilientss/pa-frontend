import { Card, CardBody, Badge, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, Form } from 'reactstrap'
...
const AllAgreementTable = () => {
  ...
  const columns = [
...

    {
      ...
      cell: row => (
        <div>
          <Badge color={row?.status === 'Active' ? 'light-success' : 'light-danger'}>{row?.status}</Badge>
        </div>
      )
    },
  ...
  return (
    ...
    <>
    <Card className='mt-2' style={{backgroundColor:"#E7EFFF",boxShadow: "0px 2.53521px 10.14085px 0px rgba(0, 0, 0, 0.25)"}}>
        <CardBody>
  ...
  <Card className='col-12'>
      <CardBody className='overflow-auto'>
        ...
        <DataTableWithButtons
          ...
          columns={columns}
          showButton={true}
          buttonClick={() => router.push(`/settings/add-agreement`)}
          buttonName={<div>
            <Plus size={16} />
            Create Role
          </div>} date={undefined} status={undefined} title={undefined}        />
      </CardBody>
    </Card>
