...
import { closeBulkUploadTaxCodesPopup } from "redux/slices/mySlices/configurations";
...
const TaxCodesBulkUploadPopup = () => {
  ...
  const helperData = useSelector(
    (state: any) => state.configurations.taxcodes.bulkUploadPopup.helperData
  );
...
const handleDownload = ()=>{
  ...
  return (
    <Modal
      isOpen={popupStatus}
      toggle={() => dispatch(closeBulkUploadTaxCodesPopup("delete"))}
...
export default TaxCodesBulkUploadPopup;
