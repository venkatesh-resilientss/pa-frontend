...
const PeriodsBulkUploadPopup = () => {
  ...
  const helperData = useSelector(
    (state: any) => state.configurations.periods.bulkUploadPopup.helperData
  );
  ...
  return (
    <Modal
      isOpen={popupStatus}
      toggle={() => dispatch(closeBulkUploadPeriodsPopup("delete"))}
    ...
    >
      <ModalBody className="d-flex flex-column" style={{ gap: "17px" }}>
        ...
        <div className="d-flex justify-content-center" style={{ gap: "8px" }}>
          <Button
            onClick={() => dispatch(closeBulkUploadPeriodsPopup("close"))}
            color="white"
            style={{
              fontSize: "14px",
              fontWeight: "400",
...
export default PeriodsBulkUploadPopup;
