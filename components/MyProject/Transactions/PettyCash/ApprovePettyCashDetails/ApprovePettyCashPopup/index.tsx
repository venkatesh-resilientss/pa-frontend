...
import { closeApprovePettyCashPopup } from "redux/slices/mySlices/transactions";

const ApprovePettyCashPopup = () => {
  const dispatch = useDispatch();

  const popupStatus = useSelector(
    (state: any) => state.transactions.pettyCash.approvePettyCashPopup.status
  );

  return (
    <Modal
      isOpen={popupStatus}
      toggle={() => dispatch(closeApprovePettyCashPopup("delete"))}
      ...
      >
        ...
        <div className="d-flex justify-content-center" style={{ gap: "8px" }}>
          <Button
            ...
            onClick={() => dispatch(closeApprovePettyCashPopup("delete"))}
            color="white"
          >
            Cancel
          </Button>
...
export default ApprovePettyCashPopup;
