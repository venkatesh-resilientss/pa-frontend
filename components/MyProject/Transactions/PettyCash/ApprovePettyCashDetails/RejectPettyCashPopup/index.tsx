...
import { closeRejectPettyCashPopup } from "redux/slices/mySlices/transactions";

const RejectPettyCashPopup = () => {
  const dispatch = useDispatch();

  const popupStatus = useSelector(
    (state: any) => state.transactions.pettyCash.rejectPettyCashPopup.status
  );

  return (
    <Modal
      isOpen={popupStatus}
      toggle={() => dispatch(closeRejectPettyCashPopup("delete"))}
      ...
      >
        ...
        <div className="d-flex justify-content-center" style={{ gap: "8px" }}>
          <Button
            ...
            onClick={() => dispatch(closeRejectPettyCashPopup("delete"))}
            color="white"
          >
            Cancel
          </Button>
...
export default RejectPettyCashPopup;
