...
import { closeApproveAccountPayablePopup } from "redux/slices/mySlices/transactions";

const ApproveAccountPayablePopup = () => {
  const dispatch = useDispatch();

  const popupStatus = useSelector(
    (state: any) =>
      state.transactions.accountPayable.approveAccountPayablePopup.status
  );

  return (
    <Modal
      isOpen={popupStatus}
      toggle={() => dispatch(closeApproveAccountPayablePopup("delete"))}
      ...
      >
        ...
        <div className="d-flex justify-content-center" style={{ gap: "8px" }}>
          <Button
            ...
            onClick={() => dispatch(closeApproveAccountPayablePopup("delete"))}
            color="white"
          >
            Cancel
          </Button>
...
export default ApproveAccountPayablePopup;
