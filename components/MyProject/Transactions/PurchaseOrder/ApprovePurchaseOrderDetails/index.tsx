...
import RejectPurchaseOrderPopup from "./RejectPurchaseOrderPopup";
import ApprovePurchaseOrderPopup from "./ApprovePurchaseOrderPopup";
import {
  openAddVendorPopup,
...
const ApprovePurchaseOrder = () => {
  ...
  return (
    <div className="my-3">
      <ApprovePurchaseOrderPopup />
      <RejectPurchaseOrderPopup />
      <div>
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex my-auto " style={{ gap: "5px" }}>
            ...
            <Button
              onClick={() => dispatch(openRejectPurchaseOrderPopup("dummy"))}
              style={{
                height: "30px",
                color: "#2D2C2C",
                borderColor: "#EF3900",
            ...
            <Button
              onClick={() => dispatch(openApprovePurchaseOrderPopup("dummy"))}
              style={{
                height: "30px",
