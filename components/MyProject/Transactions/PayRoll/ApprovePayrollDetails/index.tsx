...
import ApprovePayrollPopup from "./ApprovePayrollPopup";
import RejectPayrollPopup from "./RejectPayrollPopup";
      ...
      <div>
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex my-auto " style={{ gap: "5px" }}>
            ...
            <Button
              onClick={() => dispatch(openRejectPayrollPopup("dummy"))}
              style={{
                height: "30px",
                color: "#2D2C2C",
                borderColor: "#EF3900",
            ...
            <Button
              onClick={() => dispatch(openApprovePayrollPopup("dummy"))}
              style={{
                height: "30px",
...
export default ApprovePayrollDetails;
