...
import { openDeletePayrollPopup } from "redux/slices/mySlices/transactions";
import { useDispatch } from "react-redux";

const AllPayrollTable = () => {
        ...
        <UncontrolledDropdown style={{ width: "112px", height: "98px" }}>
          ...
          >
            ...
            <DropdownItem
              ...
              className="w-100"
              onClick={(e) => {
                e.preventDefault(), dispatch(openDeletePayrollPopup("delete"));
              }}
            >
