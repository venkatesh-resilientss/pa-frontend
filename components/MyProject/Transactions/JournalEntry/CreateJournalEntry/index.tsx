...
const CreateJournalEntry = () => {
          ...
          <Row>
            ...
            >
              <Button
                className=""
                onClick={() =>
                  dispatch(openAddMoreLinesToJournalEntryPopup("id"))
                }
                style={{
                  backgroundColor: "transparent",
                  border: "none",
  ...
  return (
    <div className="my-3">
      <AddMoreLinesToJournalEntryPopup />
      <div>
      ...
      >
        ...
        >
          <Button
            className=""
            onClick={() => dispatch(openAddMoreLinesToJournalEntryPopup("id"))}
            style={{
              backgroundColor: "transparent",
              border: "none",
              padding: "8px 16px",
...
import AddMoreLinesToJournalEntryPopup from "../AddMoreLinesPopup";
import { openAddMoreLinesToJournalEntryPopup } from "redux/slices/mySlices/transactions";
