...
import ApproveJournalEntryPopup from "./ApproveJournalEntryPopup";
import RejectJournalEntryPopup from "./RejectJournalEntryPopup";
import {
...
const ApproveJournalEntryDetails = () => {
  ...
  return (
    <div className="my-3">
      <ApproveJournalEntryPopup />
      <RejectJournalEntryPopup />
      <div>
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex my-auto " style={{ gap: "5px" }}>
            ...
            <Button
              onClick={() => dispatch(openRejectJornalEntryPopup("dummy"))}
              style={{
                height: "30px",
                color: "#2D2C2C",
                borderColor: "#EF3900",
            ...
            <Button
              onClick={() => dispatch(openApproveJornalEntryPopup("dummy"))}
              style={{
                height: "30px",
                ...
                <CardBody>
                  <div>
                    ...
                    <Row className="mt-2">
                      <Col sm="4">
                        <FormGroup>
                          <Label style={{ color: "#030229" }}>JE Number</Label>
                          <Input
                            name="select"
                            placeholder="10892929 "
...
export default ApproveJournalEntryDetails;
