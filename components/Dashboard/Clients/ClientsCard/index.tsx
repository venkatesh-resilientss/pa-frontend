...
import carbonDecumentView from "public/assets/DashboardIcons/carbonDecumentView.svg";
import user from "public/assets/DashboardIcons/person.svg";
import fluentEmoji from "public/assets/DashboardIcons/fluentEmoji.svg";
  ...
  return (
    ...
    >
      ...
      <div className="d-flex gap-1 mt-2">
        {data.softwares.map((software: any, i: any) => {
          <div
            style={{
              fontSize: "10px",
              fontWeight: "400",
