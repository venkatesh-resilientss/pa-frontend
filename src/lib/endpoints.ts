...
export const BANKS_DETAIL_ENDPOINT = (id: string) => `/api/banks/${id}`; // Bank Details
...
export const COUNTRIES_DETAIL_ENDPOINT = (id: string) => `/api/countries/${id}`; //countries Details
...
export const SERIES_DETAIL_ENDPOINT = (id: string) => `/api/series/${id}`; //Series Details
...
export const DEPARTMENT_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/departments/${id}`;
...
export const VENDORS_DETAIL_ENDPOINT = (id: string) => `${baseUrl}/api/vendors/${id}`; //Vendors Details
...
export const STATES_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/states/${id}`; //States Details
...
export const TAXCODES_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/taxcodes/${id}`; //Tax Codes Details
...
export const LOCATION_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/locations/${id}`; //Location Details

export const GET_COAACCOUNTS = `${baseUrl}api/coaaccounts/`; //COA(ACCOUNTS)
export const DELETE_COAACCOUNTS =(id: any)=> `${baseUrl}api/coaaccounts/${id}`; //DELETE coaaccounts
export const EDIT_COAACCOUNTS = (id: any)=>`${baseUrl}api/coaaccounts/${id}`; //EDIT coaaccounts
export const COAACCOUNTS_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/coaaccounts/${id}`; //coa Accounts Details
...
export const CLIENTS_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/clients/${id}`; //clients Details
...
export const PERIODS_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/periods/${id}`; //periods Details
...
export const USERS_DETAIL_ENDPOINT = (id: string) => `${baseUrl}api/users/${id}`; //Users Details
