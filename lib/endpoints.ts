...
export const BANKS_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/banks/${id}`; // Bank Details
...
export const SERIES_DETAIL_ENDPOINT = (id: any) => `${tenantIdEndpoint}/series/${id}`; //Series Details
...
export const DELETE_CURRENCIES = (id:any) => `${tenantIdEndpoint}/currencies/${id}`; //DELETE Currencies
export const EDIT_CURRENCIES = (id:any) => `${tenantIdEndpoint}/currencies/${id}`; //EDIT currencies
export const CURRENCY_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/currencies/${id}`; //currencies Details
...
export const BUDGETS_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/budgets/${id}` // budgets Details
...
export const DELETE_COUNTRIES = (id:any) => `${tenantIdEndpoint}/countries/${id}` //DELETE countries
export const EDIT_COUNTRIES = (id:any) => `${tenantIdEndpoint}/countries/${id}` //EDIT countries
export const COUNTRIES_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/countries/${id}` //countries Details
...
export const EDIT_DEPARTMENTS = (id:any) => `${tenantIdEndpoint}/departments/${id}`; //EDIT Departments
...
export const SETS_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/sets/${id}`; //Sets Details
...
export const DELETE_TAXCODES = (id:any) => `${tenantIdEndpoint}/taxcodes/${id}`; //DELETE taxcodes
...
export const DELETE_LOCATION = (id:any) => `${tenantIdEndpoint}/locations/${id}`; //DELETE Locations
...
export const EDIT_COAACCOUNTS = (id:any) => `${tenantIdEndpoint}/coaaccounts/${id}`; //EDIT coaaccounts
export const COAACCOUNTS_DETAIL_ENDPOINT = (id:any) =>
  `${tenantIdEndpoint}/coaaccounts/${id}`; //coa Accounts Details



export const GET_CLIENTS =  `${tenantIdEndpoint}/clients/`; //Clients
...
export const GET_USERS =  `${tenantIdEndpoint}/users/?limit=100&offset=0`; //Users
...
export const USERS_DETAIL_ENDPOINT = (id:any) => `${tenantIdEndpoint}/users/${id}`; //Users Details
